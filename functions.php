<?php
    ...
    function generateRandomCard($sql){
        session_start();
        $userId = $_SESSION['userId'];
        $conn = mysqli_connect("us-cdbr-east-04.cleardb.com", "be18b79a8458a8", "350744db", "heroku_54df87b96adc2fd"); // connect to DB
        mysqli_set_charset($conn,"utf8");
    ...
    function generateThreeCard($sql, $tag, $search, $sort){
        session_start();
        $userId = $_SESSION['userId'];
        $conn = mysqli_connect("us-cdbr-east-04.cleardb.com", "be18b79a8458a8", "350744db", "heroku_54df87b96adc2fd"); // connect to DB
        mysqli_set_charset($conn,"utf8");

        $num_per_page = 3; // total item per page
    ...
    function generatePersonalCard($sql, $tag, $search, $sort){
